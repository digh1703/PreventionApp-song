...
public class CrimeMap2 extends AppCompatActivity implements Overlay.OnClickListener,OnMapReadyCallback,NaverMap.OnCameraChangeListener, NaverMap.OnCameraIdleListener {
    ...
    public void onMapReady(@NonNull NaverMap naverMap) {
        ...
        infoWindow.setAdapter(new InfoWindow.DefaultViewAdapter(this) {
            ...
            protected View getContentView(@NonNull InfoWindow infoWindow) {
                ...
                View view=View.inflate(CrimeMap2.this, R.layout.view_info_window_murder,null);
